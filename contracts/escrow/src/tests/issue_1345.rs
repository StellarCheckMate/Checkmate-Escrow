...
fn make_config(admin: &Address, stablecoin_only_mode: bool) -> ProtocolConfig {
    ProtocolConfig {
...
fn test_stablecoin_mode_event_emitted_on_toggle() {
    ...
    client.set_protocol_config(&make_config(&admin, true));
...
fn test_stablecoin_mode_event_not_emitted_when_unchanged() {
    ...
    client.set_protocol_config(&make_config(&admin, false));
